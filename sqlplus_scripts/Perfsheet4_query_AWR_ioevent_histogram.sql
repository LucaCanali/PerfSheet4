...
-- Perfsheet4_query_AWR_ioevent_histogram.sql -> Extracts data from dba_hist_event_histogram for I/O related events. This provide drill-down 
-- information on latency. The query computes delta values between snapshots and rates (i.e. delta values divided over delta time).
