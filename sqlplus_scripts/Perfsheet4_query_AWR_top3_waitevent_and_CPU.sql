--
-- Perfsheet4_query_AWR_top3_waitevent_and_CPU.sql -> Extracts data from dba_hist_system_event and dba_hist_sysstat, 
...
set termout on
prompt 
prompt Dumping AWR data to file Perfsheet4_AWR_top3_waitevent_and_CPU_&myfilesuffix..csv, please wait
prompt 
set termout off

spool Perfsheet4_AWR_top3_waitevent_and_CPU_&myfilesuffix..csv
